...
audio (a)
{
   ...
   // a.setOscillatorType(sin, sin2);
    ...
    /*Lambda function to call play function that accesses nextaudioblock when metronome button clicked */
  //  metStartButton.thisButton.onClick = [this](){play();};
    
    
   
    getLookAndFeel().setColour (juce::Slider::thumbColourId, juce::Colours::red);
    
//    filterSliders[0].setLookAndFeel(&f);
